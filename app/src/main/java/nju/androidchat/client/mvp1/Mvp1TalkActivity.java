...
import nju.androidchat.client.mvc1.Mvc1BackupActivity;

@Log
public class Mvp1TalkActivity extends AppCompatActivity implements Mvp1Contract.TalkView, TextView.OnEditorActionListener, OnRecallMessageRequested {
    private Mvp1Contract.TalkPresenter presenter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main_with_backup_btn);

        Mvp1TalkModel mvp1TalkModel = new Mvp1TalkModel();

        // Create the presenter
        this.presenter = new Mvp1TalkPresenter(mvp1TalkModel, this, new ArrayList<>());
        mvp1TalkModel.setIMvp0TalkPresenter(this.presenter);
    }
    ...
    @Override
    public void setPresenter(Mvp1Contract.TalkPresenter presenter) {
    ...
    public void onBtnToBackupClicked(View view) {
        Utils.jumpTo(this, Mvp1BackupActivity.class);
    }
